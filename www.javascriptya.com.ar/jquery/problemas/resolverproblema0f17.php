...
<div style="font-size:1.3em;font-family:arial;"><p>Disponer dos párrafos. Capturar el evento click solo del primero utilizando la librería jQuery.</p></div><br><a href="javascript:cambiar()" id="solucion">Ver solución</a><br><br><b>pagina1.html</b><input type="hidden" name="archivo1" value="pagina1.html"><br><textarea rows="15" cols="110" name="programa1" wrap="off"></textarea><br><br><input type="submit"  value="Ejecutar el programa.">
<table width="650px">
<tr>
<td align="left">	
<script type="text/javascript"><!--
