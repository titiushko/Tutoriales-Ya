...
<p>Mostramos los títulos de los libros de "Borges" de editoriales que han publicado también libros de "Richard Bach":</p>
<pre>
 select titulo
  from libros
...
<p>Mostramos los títulos y precios de los libros "Borges" cuyo precio supera a ALGUN precio de los libros de "Richard Bach":</p>
<pre>
...
<p>Empleamos la misma subconsulta para eliminación:</p>
<pre>
 delete from libros
  where autor like '%Borges%' and
  precio > all
